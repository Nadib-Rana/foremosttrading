...
import { MaterialDropdowns } from "./MaterialDropdowns";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 flex flex-col pt-2 lg:pt-4">
          ...
          <MaterialDropdowns
            ...
            onChangeFrontClosure={setFrontClosure}
            bodyMaterial={bodyMaterial}
            onChangeBodyMaterial={setBodyMaterial}
            sleevesMaterial={sleevesMaterial}
            onChangeSleevesMaterial={setSleevesMaterial}
          />
